...
| Objetivo do Teste | Verificar se os links da página Home estão encaminhando para as respectivas páginas corretamente. Verificar se a página inicial exibe os eventos e se eles estão linkados corretamente.|
| Passos | 1. Acessar o navegador. 2. Informar o endereço do site. 3. Visualizar a página Home. 4. Clicar nos links da página Home (Eventos, Login ou Cadastre-se, Sobre, Dúvidas Frequentes, Saiba Mais, Shows do Gênero e Link do Youtube). |
| Critérios de êxito | Todos os links da home devem encaminhar para a página respectiva página corretamente. |
| Responsável por elaborar o caso de Teste | Maria Vitória |
...
| Passos | 1. Acessar o navegador. 2. Informar o endereço do site. 3. Visualizar a página Home. 4. Clicar em "login", no menu. 5. Preencher os dados e clicar no botão "login".(Para ambos os tipos de login) |
| Critérios de êxito | Após o login, o usuário deverá ser redirecionado à página inicial.  |
| Responsável por elaborar o caso de Teste | Thabata |

|Caso de Teste    | CT-03 - Verificar o cadastro de eventos |
|:---|:---|
| Requisitos Associados | RF-03: A plataforma deve permitir cadastro de novos eventos para o perfil do produtor; RF-04: A plataforma deve permitir edição do evento para o usuário que o publicou. |
...
| Responsável por elaborar o caso de Teste | Larissa |
...
| Critérios de êxito | Ao selecionar o favorito de algum evento ele deve aparecer dentro da sessão "Favoritos" na página de usuário.  |
...
| Objetivo do Teste | Verificar a hospedagem do site. |
| Passos | Indicar passos para a execução do teste. |
| Critérios de êxito | O site deve funcionar corretamente aonde estiver hospedado.  |
